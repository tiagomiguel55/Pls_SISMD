...
public class ApplyFilters {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Each implementation is instantiated once (image loaded once, pool created once).
        // Only processImage() is measured — no I/O, no thread creation overhead.
